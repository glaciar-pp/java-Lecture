...
public class Ex32_BankApplicationS {

	private static Ex32_AccountS[] accountArray = new Ex32_AccountS[100];
	...
	private static void withdraw() {
		...
		Ex32_AccountS account = findAccount(ano);
		if (account == null) {
	...
	private static Ex32_AccountS findAccount(String ano) {
			for (Ex32_AccountS acc: accountArray) {
				if (acc == null)
					break;
	...
	private static void createAccount() {
		...
		accountArray[index++] = new Ex32_AccountS(ano, owner, balance);
